...
ALTER SEQUENCE dept3_seq MAXVALUE 9999; -- 최대값 설정
ALTER SEQUENCE dept3_seq INCREMENT BY 10; -- 증가값 변경
ALTER SEQUENCE dept3_seq MINVALUE 0; -- 최소값 설정

-- 시퀀스 값을 다시 처음으로 돌리는 방법
ALTER SEQUENCE dept3_seq INCREMENT BY -16;
SELECT sept3_seq.NEXTVAL FROM dual;
...
-- 지정된 인덱스를 강제로 쓰게끔 지정
-- INDEX ASC< DESC를추가해서 내림차, 오름차 순으로 쓰게끔 지정가능
